    ...
    public void drawShips(){
        for (int i = 0; i < ships.size(); i++) {
            if(ships.get(i).getDirection() == 'n' || ships.get(i).getDirection() == 'N'){
                int col = ships.get(i).getLocation().charAt(1) - 48;
                for(int z = 0; z < ships.get(i).getLength(); z++) {
                    int row = (ships.get(i).getLocation().charAt(0) - z) - 65;
                        bottom[row][col] = "O";
                }
            }
                ...
                int row = (ships.get(i).getLocation().charAt(0)) - 65;
                for(int z = 0; z < ships.get(i).getLength(); z++) {
                    int col = ships.get(i).getLocation().charAt(1) + z - 48;
                        bottom[row][col] = "O";
                }
            }
